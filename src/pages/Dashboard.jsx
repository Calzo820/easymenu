    ...
    <div style={glowPageStyle}>
      ...
      <div style={appShellStyle}>
        <div className="app-shell">
          ...
          <div className="restaurant-os-command" style={{ marginBottom: 16 }}>
            <div className="os-command-left">
              <div className="os-eyebrow"><span className="status-dot" style={{ background: liveBadge.includes("attivo") ? "#22c55e" : "#f59e0b" }} /> Restaurant OS · {liveBadge}</div>
              <h1>{restaurantName}</h1>
              <p>Una sola cabina di regia: sala, cucina, bar e cassa. Tutto quello che serve oggi, niente di più.</p>
              <div className="os-command-actions">
                <Link to="/tavoli">Sala</Link>
                <Link to="/cucina">Cucina</Link>
                <Link to="/bar">Bar</Link>
                <Link to="/cassa">Cassa</Link>
              </div>
            </div>
            <div className="os-command-metrics">
              <div><b>{kpis.activeTables || 0}/{kpis.totalTables || 0}</b><span>Tavoli attivi</span></div>
              <div><b>{kpis.openOrders || 0}</b><span>Ordini aperti</span></div>
              <div><b>{euro(kpis.revenueToday)}</b><span>Incasso oggi</span></div>
              <div><b>{kpis.unresolvedErrors || 0}</b><span>Alert aperti</span></div>
            </div>
          </div>
