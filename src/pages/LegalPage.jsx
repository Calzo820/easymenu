...
const pages = {
  ...
  "/cookie": {
    ...
    sections: [
      ["Cookie tecnici", "EasyMenu puo usare cookie o storage locale per sessione, autenticazione, preferenze interfaccia, carrello e stato ordine."],
      ...
      ["Terze parti", "Stripe puo usare tecnologie proprie durante checkout e portale billing secondo le proprie policy."],
